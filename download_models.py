...
def setup_musetalk_models():
    ...
    try:
        from lip_sync_models import create_musetalk_placeholder
    ...
    print("-" * 30)
    try:
        from lip_sync_models import download_wav2lip_model
    ...
    print("-" * 30)
    try:
        from lip_sync_models import setup_latentsync_env
